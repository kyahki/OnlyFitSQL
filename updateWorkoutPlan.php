...
<head>
    ...
    <link href="css/updateWorkoutPlan.css" rel="stylesheet">
...
<body>
    ...
    <form method="post">
        <table class="table2">
            ...
            <tr>
                <td class="td1">Place New Workout Type: </td>
...
//     $sql = "UPDATE tblworkoutplan SET workouttype='$workoutplantype', workoutdescription='$workoutplandescription' WHERE id=$id_value";
